...
// Include proto headers FIRST to avoid name conflicts with internal types
...
// Now include internal headers (which define Internal types that alias to avoid conflicts)
...
private:
    ...
    IMIXEntryInternal convert_proto_imix_entry(const IMIXEntry& entry);
};
